        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
            ...
            <p className="text-gray-600 mb-6">
              Keep your emergency contacts updated for quick access during
              critical situations.
            </p>
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    type="text"
                    className="mt-1 block w-full border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-300 focus:ring-opacity-50"
              ...
              <button
                type="submit"
                className="rounded-md w-full bg-blue-500 text-white py-2 px-4 font-semibold hover:bg-blue-600 transition-colors"
              >
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
            ...
            <div className="space-y-4">
              <button
                onClick={makeCall}
                className="rounded-md w-full bg-blue-500 text-white py-3 px-4 font-semibold hover:bg-blue-600 transition-colors"
              >
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-blue-500 px-4 py-3 bg-blue-100">
                ...
                <p className="text-sm text-gray-600">
                  City General Hospital (0.8 miles)
                </p>
